...
TEST_CASE("Non-ident label") {
    helpers::test_parser_fail("2: {};",
                              syntax::ParserDiagnostic{syntax::ParserError::ILLEGAL_LABEL, 1, 1});
}

TEST_CASE("Illegal label expressions") {
    helpers::test_parser_fail(
        "a: 3;", syntax::ParserDiagnostic{syntax::ParserError::ILLEGAL_LABEL_EXPRESSION, 1, 4});

    helpers::test_parser_fail(
        "a: b;", syntax::ParserDiagnostic{syntax::ParserError::ILLEGAL_LABEL_EXPRESSION, 1, 4});
    ...
    helpers::test_parser_fail(
        "a: b: c: {};",
        syntax::ParserDiagnostic{syntax::ParserError::ILLEGAL_LABEL_EXPRESSION, 1, 7});
}

TEST_CASE("Illegal label statements") {
    helpers::test_parser_fail(
        "a: defer 3;",
        syntax::ParserDiagnostic{syntax::ParserError::ILLEGAL_LABEL_STATEMENT, 1, 4});
