...
The developer experience has been set up in such a way that the only system dependency is [Zig v0.15.2](https://ziglang.org/download/). This standard should be upheld in all PRs, adding all new dependencies to the project `build.zig.zon` and adding any build steps to the `third-party` directory.
